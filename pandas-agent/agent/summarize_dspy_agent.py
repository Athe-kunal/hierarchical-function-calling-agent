...
def get_summaries(pandas_graph):
    ...
    json.dump(parent_summary_dict, open( config_params['PARENTS_SUMMARY']['SUMMARY_JSON_FILE_PATH'], 'w' ) )
    print(f"Summaries saved to {config_params['PARENTS_SUMMARY']['SUMMARY_JSON_FILE_PATH']}")